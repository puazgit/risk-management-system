            ...
            <div className="overflow-x-auto">
              <div className="inline-block min-w-full">
                ...
                <div className="flex items-center mb-4">
                  <div className="w-20 text-sm font-medium origin-center transform -rotate-90">
                    Impact
                  </div>
                  <div className="ml-4">
                    {/* Heat map grid */}
                ...
                {/* X-axis title */}
                <div className="mt-2 text-sm font-medium text-center">Probability</div>
              </div>
            </div>
          </CardContent>
        </Card>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b">
                    <th className="p-2 text-left">Risk Name</th>
                    ...
                    <th className="p-2 text-left">KRIs</th>
                  </tr>
                </thead>
                <tbody>
